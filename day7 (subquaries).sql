...
from employee1 where age>(select avg(age) from employee1);

select emp_id, emp_name, age, salary
from employee1 where age>(select age from employee1 where emp_name="Bob");
...
select productcode, productname, msrp from product
